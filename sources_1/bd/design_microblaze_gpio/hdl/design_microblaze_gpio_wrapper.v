...
//Command     : generate_target design_microblaze_gpio_wrapper.bd
//Design      : design_microblaze_gpio_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module design_microblaze_gpio_wrapper
   (led_tri_io,
    reset,
    sys_clock,
    usb_uart_rxd,
  ...
  design_microblaze_gpio design_microblaze_gpio_i
